if (TRUE){
  ...
  eg <- expand.grid(restrict = c("", "ppc", "true", "cig", bnlearn:::constraint.based.algorithms),
                    maximize = c("", bnlearn:::score.based.algorithms),
                    test = "mi",
                    score = "bic",
                    alpha = c(1e-4, 1e-2),
                    undirected = c(FALSE, TRUE),
                    sort_pval = c(FALSE, TRUE),
                    path = c(1, 10),
                    hgi = c(FALSE, TRUE),
